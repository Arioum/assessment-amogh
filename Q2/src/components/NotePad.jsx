...
const NotePad = () => {
  ...
  return (
    <div className='flex-1 flex flex-col max-h-[500px] p-[1em] border rounded-[10px] shadow-[0px_0px_8px_1px_#e2e8f0]'>
      <h3 className='px-1 text-[1.8rem] font-[800]'>NotePad</h3>
